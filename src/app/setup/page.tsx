    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <img src="/branding/logo-horizontal-dark.svg" alt="Mainline" className="mx-auto mb-4 h-12 w-auto dark:hidden" />
          {/* eslint-disable-next-line @next/next/no-img-element -- SVG logo, no optimization benefit */}
          <img src="/branding/logo-horizontal-light.svg" alt="Mainline" className="mx-auto mb-4 h-12 w-auto hidden dark:block" />
